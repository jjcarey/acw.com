...
<div role="document" class="page">
  ...
  <main role="main" class="l-main">
    ...
    <div class="displayCount">
      <!-- <div class="photoUpNum"></div> -->
      <?php $directory = "sites/default/files/user_photos/";
        $filecount = 0;
        $files = glob($directory . "*.{png,gif,jpg,jpeg}", GLOB_BRACE);
        if ($files){ $filecount = count($files); }
        print '<div class="photoUpNum"><h1>' . $filecount . '</h1></div>';
      ?>
      <!-- <div class="userNum"></div> -->
      <?php $result = db_query("SELECT count(1) from {users}")->fetchField();
        print '<div class="userNum"><h1>' . $result . '</h1></div>';
      ?>
      <!-- <div class="messageNum"></div> -->
